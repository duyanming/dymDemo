...
namespace YY.AppCenter.Accept
{
    ...
    public class ThriftConfig
    {
        ...
        private void Init()
        {
            string xmlPath = Path.Combine(Directory.GetCurrentDirectory(), "dym.config");
        ...
        private bool Save()
        {
            ...
            {
                XmlDocument xml = new XmlDocument();
                xml.Load(Path.Combine(Directory.GetCurrentDirectory(), "dym.config"));
                ...
                xml.Save(Path.Combine(Directory.GetCurrentDirectory(), "dym.config"));
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex);
